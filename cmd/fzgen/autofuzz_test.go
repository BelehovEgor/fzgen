...
func Fuzz_MyPrinter_Print(f *testing.F) {
...
func Fuzz_MyEmiter(f *testing.F) {
	f.Fuzz(func(t *testing.T, data []byte) {
		var s string
		fz := fuzzer.NewFuzzerV2(data, FabricFuncsForCustomTypes)
		err := fz.Fill2(&s)
...
func fabric_func_6_0() func(string) bool {
...
func TestMain(m *testing.M) {
	...
	FabricFuncsForCustomTypes["func(string) bool"] = append(FabricFuncsForCustomTypes["func(string) bool"], reflect.ValueOf(fabric_func_6_0))
